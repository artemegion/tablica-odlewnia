export class TimeV2 {
    ...
    /**
     * Create an instance of `TimeV2` from `hour` and `minute`.
     * @param {number} hour 
     * @param {number} minute 
     */
    ...
    /**
     * Create an instance of `TimeV2`, from amount of minutes passed since 0:00.
     * @param {number} ticks 
     */
    constructor(ticks) {
    ...
    /**
     * The amount of minutes that have passed since 0:00.
     * @type {number}
     */
    ticks;
