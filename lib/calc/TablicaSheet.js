        ...
        this.addCells({
            ...
            'strata-predkosci-b1-polowa': {
                ...
                formula: ((czasStrat, czyszczenie, strataPrzestoj) => Math.floor(
                    (czasStrat - czyszczenie.sum() - (this.state.useDetailedSpeedLoss ? strataPrzestoj.sum() : 0)) / 2)
                )
            },
            ...
            'oeu': {
                ...
                //                                                                                                                                            960 minutes in 8 hours
                formula: (splywNarastajacoKoniec, takt, celLiniiKoniec) => Math.round(((splywNarastajacoKoniec * takt) / 960) * 100)
            },
            'plan-produkcji': {
                valueType: 'int',
                defaultValue: undefined,
