...
export class TablicaFormAutomaty extends LitElement {
    constructor() {
        super();
    }

    /** @type {AutomatyTablicaState | undefined} */ state;
    ...
    render() {
        ...
        <div class="form">
            ...
            <fieldset style="margin-bottom: 0;">
                ...
                <input id="czyszczenie-b1-polowa" title="Czyszczenie połowa - bramka 1" type="number" value="20" class="join-to-bottom" />
                <input id="czyszczenie-b2-polowa" title="Czyszczenie połowa - bramka 2" type="number" value="20" />
                <input id="czyszczenie-b3-polowa" title="Czyszczenie połowa - bramka 3" type="number" value="20" />
                <input id="czyszczenie-b1-koniec" title="Czyszczenie koniec - bramka 1" type="number" value="20" />
                <input id="czyszczenie-b2-koniec" title="Czyszczenie koniec - bramka 2" type="number" value="20" />
                <input id="czyszczenie-b3-koniec" title="Czyszczenie koniec - bramka 3" type="number" value="20" class="join-to-bottom" />
            </fieldset>
            </foldable-content>
            ...
            <fieldset disabled style="margin-bottom: 0;">
                ...
                <input id="strata-predkosci-b3-polowa" title="Strata prędkości bramka 3 - połowa" type="number" />
                ...
                <input id="strata-predkosci-b3-koniec" title="Strata prędkości bramka 3 - koniec" type="number" />
            </fieldset>
            <br />
...
customElements.define('tablica-form-automaty', TablicaFormAutomaty);
